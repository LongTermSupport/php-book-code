...
use Book\Part1\Chapter2\TypeDeclarations\ModernClass;
use Book\Part1\Chapter2\TypeDeclarations\YeOldeClass;
use Book\Part1\Chapter2\TypeDeclarations\YeOldeDefensive;
use ReflectionClass;
...
try {
    $yeOldeDefensive = new YeOldeDefensive([1, 2, 3], new stdClass(), '1', 123, 'yes');
} catch (RuntimeException $runtimeException) {
    echo "\nFailed instantiating, got this error: " . $runtimeException->getMessage();
}
/*
