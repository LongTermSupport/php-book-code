 ...
 * Way back when we had to use a whole boat load of comments and boilerplate to define types.
 * Unfortunately its about as defensively useful as a chocolate teapot.
 */
