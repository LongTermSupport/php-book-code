...
echo "\n" . '$instanceOne identical to $instanceTwo?  ' . var_export($instanceOne === $instanceTwo, true) . "\n";

echo "\n" . '$instanceOne equal to $instanceTwo?      ' . var_export($instanceOne == $instanceTwo, true) . "\n";

echo "\n" . '$instanceOne identical to $referenceOne? ' . var_export($instanceOne === $referenceOne, true) . "\n";
