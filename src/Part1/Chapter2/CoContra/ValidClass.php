...
{
    /**
     * Contravariant with ParentClass, param type moved up a notch on the hierarchical chain
     * Covariant with ParentClass, return type moved down a notch on the hierarchical chain.
     */
